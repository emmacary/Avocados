...
http.createServer(function (req, res) {
    if (req.url == "https://plarent.herokuapp.com/" || req.url == "https://plarent.herokuapp.com/index.html")
    {
        file = 'index.html';
    ...
    else if (req.url == "https://plarent.herokuapp.com/map.html")
    {
        file = 'map.html';
        fs.readFile(file, function(err, txt) {
            res.writeHead(200, {'Content-Type': 'text/html'});
    ...
    else if (req.url == "https://plarent.herokuapp.com/map.html/process")
    {
        res.writeHead(200, {'Content-Type': 'text/html'});
        pdata = "";
        req.on('data', data => {
    ...
    else if(req.url == "https://plarent.herokuapp.com/plantdata.html") 
    {
        file="plantdata.html";
        fs.readFile(file, function(err, txt) {
          res.writeHead(200, {'Content-Type': 'text/html'});
    ...
    else if(req.url == "https://plarent.herokuapp.com/plantdata.html/search") 
    {
        file="plantdata.html";
        fs.readFile(file, function(err, txt) {
          res.writeHead(200, {'Content-Type': 'text/html'});
      ...
      else if (req.url == "https://plarent.herokuapp.com/plantdata.html/insert") 
      {
        file="plantdata.html";
        fs.readFile(file, function(err, txt) {
          res.writeHead(200, {'Content-Type': 'text/html'});
    ...
    else if (req.url == "https://plarent.herokuapp.com/contact.html"){
        file="contact.html";
        fs.readFile(file, function(err, txt) {
          res.writeHead(200, {'Content-Type': 'text/html'});
          res.write(txt);
